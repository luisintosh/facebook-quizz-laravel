...
@section('meta_title', __('Políticas de privacidad'))
@section('meta_description', __('Políticas de privacidad'))
@section('meta_image', asset('images/site/web.jpg'))
@section('meta_url', route('privacy'))
        ...
        <div class="col-md-6">
            <div class="card shadow-sm rounded mb-4">
                <div class="card-body">
                    ...
                    <p>Fecha efectiva: November 01, 2018</p>


                    <p>OKOK ("nosotros", "a nosotros", "nuestro") opera el sitio web https://okok.website/ (en adelante, el "Servicio").</p>
                    ...
                    <p>Utilizamos sus datos para prestarle el Servicio y mejorarlo. Al utilizar el Servicio, usted acepta la recopilación y el uso de información de conformidad con esta política. A menos que esta Política de privacidad defina lo contrario, los términos utilizados en ella tienen los mismos significados que nuestros Términos y Condiciones, disponibles en el https://okok.website/</p>

                    <h2>Definiciones</h2>
                    <ul>
                        <li>
                            <p><strong>Servicio</strong></p>
                            <p>Servicio es el sitio web https://okok.website/ operado por OKOK</p>
                        </li>
                        <li>
                    ...
                    <h2>Uso de datos</h2>
                    <p>OKOK utiliza los datos recopilados con diversas finalidades:</p>
                    <ul>
                    ...
                    <ul>
                        <li>Por e-mail: hello@okok.website</li>
